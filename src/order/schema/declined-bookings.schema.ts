...
export type Declined_bookingsDocument = HydratedDocument<Declined_bookings>;
export const Declined_bookingsModel =
  SchemaFactory.createForClass(Declined_bookings);
