...
export class PharmacyController {
    ...
    uploadGroceryCsv(@Request() req, @Body() dto: GroceryCsvDto) {
        return this.GroceryService.uploadItemsCsv(req, dto, RestaurantType.Pharmacy);
    }
    ...
    findAllGroceryItems(@Query() dto: ListGroceryItemsDto) {
        return this.GroceryService.findAll(Number(dto.page), Number(dto.limit), dto.search, RestaurantType.Pharmacy);
    }
    ...
    findByCategory(@Query() query: FindByCategoryDto, @Req() req: any) {
        return this.GroceryService.findByCategoryName(query, query.page, query.limit, RestaurantType.Pharmacy, req);
    }
